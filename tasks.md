...
- [x] **Task 2-G: 操作フィードバック（エラー表示、モード表示）**
...
- [x] **Task 3-E: Info Panel — 部屋/仙獣/侵入者の詳細表示**
