...
- [ ] **Task 1-B: core修正 — SimpleAIPlayerコリドー戦略**
...
- [ ] **Task 1-C: core修正 — caveScore正規化（呼び出し側）**
...
- [ ] **Task 4-C: Metrics — 壊れるサイン検出メトリクス B10〜B11**
...
- [ ] **Task 4-D: Metrics — BreakageReport（閾値判定・アラート生成）**
